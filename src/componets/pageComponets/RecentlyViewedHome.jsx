                ...
                <div className="w-full aspect-[3/4] relative overflow-hidden bg-[#F0F7F3] border-b border-emerald-900/15">
                  ...
                  {activeTag && (
                    <div className="absolute top-2 left-2 z-20 px-2 py-[2px] bg-emerald-950/90 backdrop-blur-md text-emerald-300 rounded-full border border-emerald-500/30 shadow-xs flex items-center gap-1 max-w-[65%] select-none">
                      ...
                      <span className="text-[7.5px] sm:text-[8.5px] font-mono font-bold tracking-wider uppercase truncate">{activeTag}</span>
                    </div>
                  )}
                  ...
                  {isAllOutOfStock && (
                    <div className="absolute inset-0 z-10 flex items-center justify-center bg-emerald-950/40 backdrop-blur-xs pointer-events-none">
                      <span className="px-2.5 py-1 sm:px-3 sm:py-1 bg-white border border-emerald-900/20 font-mono text-[8px] sm:text-[9px] font-black tracking-widest uppercase text-emerald-950 rounded-full shadow-xs">Sold Out</span>
                    </div>
                  )}
