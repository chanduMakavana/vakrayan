                ...
                <div className="w-full aspect-[3/4] relative overflow-hidden bg-[#F0F7F3] border-b border-emerald-900/15">
                  ...
                  {isAllOutOfStock && (
                    <div className="absolute inset-0 z-10 flex items-center justify-center bg-emerald-950/40 backdrop-blur-xs pointer-events-none">
                      <span className="px-2.5 py-1 sm:px-3 sm:py-1.5 bg-white border border-emerald-900/20 font-mono text-[8.5px] sm:text-[10px] font-black tracking-widest uppercase text-emerald-950 rounded-xs shadow-xs">Sold Out</span>
                    </div>
                  )}
