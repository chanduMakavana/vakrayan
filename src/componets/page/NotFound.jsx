  ...
  return (
    <div className="w-full min-h-screen bg-[#f5f3ee] text-[#1a1a1a] flex flex-col justify-between selection:bg-black selection:text-white font-sans relative overflow-hidden">
      ...
      <header className="relative z-20 pt-6 md:pt-8 px-6 md:px-12 max-w-7xl mx-auto w-full flex justify-between items-center">
        ...
        <span className="font-mono text-[11px] uppercase tracking-[0.25em] text-[#737373] bg-white/70 px-3.5 py-1 rounded-full backdrop-blur-xs border border-black/10">
          PAGE 404
        </span>
      </header>
      ...
      <footer className="relative z-20 pb-8 md:pb-10 px-6 max-w-md mx-auto w-full text-center flex flex-col items-center gap-3">
        <Link
          to="/"
          className="inline-flex items-center justify-center gap-2.5 px-8 py-3.5 bg-black hover:bg-neutral-800 text-white font-bold text-xs tracking-widest uppercase rounded-full shadow-lg hover:scale-105 active:scale-95 transition-all cursor-pointer"
        >
          <FiArrowLeft className="text-sm" />
          Back to Home
        </Link>
        
        <p className="text-[10px] font-mono tracking-[0.25em] text-[#737373] uppercase pt-1">
